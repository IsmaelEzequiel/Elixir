defmodule TwitchChatWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TwitchChatWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TwitchChatWeb.Gettext, "errors", msg, opts)
    end
  end
